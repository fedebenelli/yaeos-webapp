...
class SoaveRedlichKwong(CEOSModelStrategy):
    @classmethod
    def get_display_name(cls) -> str:
        return "Soave-Redlich-Kwong (SRK)"

    @classmethod
    def get_description(cls) -> str:
        return "Soave modification of Redlich-Kwong equation of state"
    ...
    def get_eos_object(cls, config):
        """Create the yaeos SoaveRedlichKwong object from config"""
